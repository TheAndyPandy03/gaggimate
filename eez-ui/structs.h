...
struct SystemStatusValue {
    ...
    bool in_menu() {
        return value.getArray()->values[FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_IN_MENU].getBoolean();
    }
    void in_menu(bool in_menu) {
        value.getArray()->values[FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_IN_MENU] = BooleanValue(in_menu);
    }
    ...
    bool bluetooth_scales() {
        return value.getArray()->values[FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_BLUETOOTH_SCALES].getBoolean();
    }
    ...
    bool grind_available() {
        return value.getArray()->values[FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_GRIND_AVAILABLE].getBoolean();
    }
    ...
    int mode() {
        return value.getArray()->values[FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_MODE].getInt();
    }
    void mode(int mode) {
        value.getArray()->values[FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_MODE] = IntegerValue(mode);
    }
    ...
    const char *network() {
        return value.getArray()->values[FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_NETWORK].getString();
    }
    ...
    const char *ip() {
        return value.getArray()->values[FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_IP].getString();
    }
    void ip(const char *ip) {
        value.getArray()->values[FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_IP] = StringValue(ip);
    }
    
    bool ap_active() {
        return value.getArray()->values[FLOW_STRUCTURE_SYSTEM_STATUS_FIELD_AP_ACTIVE].getBoolean();
    }
...
struct ProfileInfoValue {
    ...
    int phases() {
        return value.getArray()->values[FLOW_STRUCTURE_PROFILE_INFO_FIELD_PHASES].getInt();
    }
    void phases(int phases) {
        value.getArray()->values[FLOW_STRUCTURE_PROFILE_INFO_FIELD_PHASES] = IntegerValue(phases);
    }
    
    int steps() {
        return value.getArray()->values[FLOW_STRUCTURE_PROFILE_INFO_FIELD_STEPS].getInt();
    }
    void steps(int steps) {
        value.getArray()->values[FLOW_STRUCTURE_PROFILE_INFO_FIELD_STEPS] = IntegerValue(steps);
    }
    
    bool is_volumetric() {
        return value.getArray()->values[FLOW_STRUCTURE_PROFILE_INFO_FIELD_IS_VOLUMETRIC].getBoolean();
    }
    ...
    bool is_current() {
        return value.getArray()->values[FLOW_STRUCTURE_PROFILE_INFO_FIELD_IS_CURRENT].getBoolean();
    }
    ...
    float target_weight() {
        return value.getArray()->values[FLOW_STRUCTURE_PROFILE_INFO_FIELD_TARGET_WEIGHT].getFloat();
    }
    ...
    bool dirty() {
        return value.getArray()->values[FLOW_STRUCTURE_PROFILE_INFO_FIELD_DIRTY].getBoolean();
    }
    void dirty(bool dirty) {
        value.getArray()->values[FLOW_STRUCTURE_PROFILE_INFO_FIELD_DIRTY] = BooleanValue(dirty);
    }
};
...
struct BoilerValue {
    ...
    BoilerValue() {
        value = Value::makeArrayRef(FLOW_STRUCTURE_BOILER_NUM_FIELDS, FLOW_STRUCTURE_BOILER, 0);
    }
    ...
    float current_pressure() {
        return value.getArray()->values[FLOW_STRUCTURE_BOILER_FIELD_CURRENT_PRESSURE].getFloat();
    }
    ...
    float target_pressure() {
        return value.getArray()->values[FLOW_STRUCTURE_BOILER_FIELD_TARGET_PRESSURE].getFloat();
    }
    ...
    float current_temperature() {
        return value.getArray()->values[FLOW_STRUCTURE_BOILER_FIELD_CURRENT_TEMPERATURE].getFloat();
    }
    ...
    float target_temperature() {
        return value.getArray()->values[FLOW_STRUCTURE_BOILER_FIELD_TARGET_TEMPERATURE].getFloat();
    }
    ...
    float max_pressure() {
        return value.getArray()->values[FLOW_STRUCTURE_BOILER_FIELD_MAX_PRESSURE].getFloat();
    }
    ...
    float max_temperature() {
        return value.getArray()->values[FLOW_STRUCTURE_BOILER_FIELD_MAX_TEMPERATURE].getFloat();
    }
...
struct UIFlagsValue {
    ...
    UIFlagsValue() {
        value = Value::makeArrayRef(FLOW_STRUCTURE_UI_FLAGS_NUM_FIELDS, FLOW_STRUCTURE_UI_FLAGS, 0);
    }
    ...
    bool brew_adjustments() {
        return value.getArray()->values[FLOW_STRUCTURE_UI_FLAGS_FIELD_BREW_ADJUSTMENTS].getBoolean();
    }
    ...
    bool grind_active() {
        return value.getArray()->values[FLOW_STRUCTURE_UI_FLAGS_FIELD_GRIND_ACTIVE].getBoolean();
    }
    ...
    bool active() {
        return value.getArray()->values[FLOW_STRUCTURE_UI_FLAGS_FIELD_ACTIVE].getBoolean();
    }
    void active(bool active) {
        value.getArray()->values[FLOW_STRUCTURE_UI_FLAGS_FIELD_ACTIVE] = BooleanValue(active);
    }
    
    bool grind_volumetric() {
        return value.getArray()->values[FLOW_STRUCTURE_UI_FLAGS_FIELD_GRIND_VOLUMETRIC].getBoolean();
    }
    ...
    bool heating_flash() {
        return value.getArray()->values[FLOW_STRUCTURE_UI_FLAGS_FIELD_HEATING_FLASH].getBoolean();
    }
    ...
    bool temperature_stable() {
        return value.getArray()->values[FLOW_STRUCTURE_UI_FLAGS_FIELD_TEMPERATURE_STABLE].getBoolean();
    }
    ...
    bool has_prev_profile() {
        return value.getArray()->values[FLOW_STRUCTURE_UI_FLAGS_FIELD_HAS_PREV_PROFILE].getBoolean();
    }
    ...
    bool has_next_profile() {
        return value.getArray()->values[FLOW_STRUCTURE_UI_FLAGS_FIELD_HAS_NEXT_PROFILE].getBoolean();
    }
...
struct BrewProcessValue {
    ...
    BrewProcessValue() {
        value = Value::makeArrayRef(FLOW_STRUCTURE_BREW_PROCESS_NUM_FIELDS, FLOW_STRUCTURE_BREW_PROCESS, 0);
    }
    ...
    void boiler_target_temperature(float boiler_target_temperature) {
        value.getArray()->values[FLOW_STRUCTURE_BREW_PROCESS_FIELD_BOILER_TARGET_TEMPERATURE] = FloatValue(boiler_target_temperature);
    }
    ...
    const char *profile_time() {
        return value.getArray()->values[FLOW_STRUCTURE_BREW_PROCESS_FIELD_PROFILE_TIME].getString();
    }
    ...
    int profile_phases() {
        return value.getArray()->values[FLOW_STRUCTURE_BREW_PROCESS_FIELD_PROFILE_PHASES].getInt();
    }
    ...
    int profile_steps() {
        return value.getArray()->values[FLOW_STRUCTURE_BREW_PROCESS_FIELD_PROFILE_STEPS].getInt();
    }
    ...
    const char *phase_type() {
        return value.getArray()->values[FLOW_STRUCTURE_BREW_PROCESS_FIELD_PHASE_TYPE].getString();
    }
    ...
    const char *phase_name() {
        return value.getArray()->values[FLOW_STRUCTURE_BREW_PROCESS_FIELD_PHASE_NAME].getString();
    }
    ...
    const char *elapsed_time() {
        return value.getArray()->values[FLOW_STRUCTURE_BREW_PROCESS_FIELD_ELAPSED_TIME].getString();
    }
    ...
    bool is_complete() {
        return value.getArray()->values[FLOW_STRUCTURE_BREW_PROCESS_FIELD_IS_COMPLETE].getBoolean();
    }
    ...
    float current_volume() {
        return value.getArray()->values[FLOW_STRUCTURE_BREW_PROCESS_FIELD_CURRENT_VOLUME].getFloat();
    }
